          ...
          <div className="flex flex-col text-center bg-muted rounded-md p-4 lg:p-14 gap-8 items-center">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg leading-relaxed tracking-tight text-gray-600 max-w-xl">
                Join over 1000+ developers using our templates to design
                stunning emails for their applications. You can focus on core
                features of your applications and leave the designing to us.
                Pick from our collection of stunning email templates and get
                started.
              </p>
            </div>
