...
export function Explore() {
  return (
    <div className="relative">
      <Section>
        <div className="flex flex-col text-center bg-muted rounded-md gap-8 items-center">
          <span className="inline-block px-3 py-1 text-xs font-medium bg-gray-200/50 text-gray-800 rounded-full">
            Templates <ArrowRight className="w-4 h-4 inline-block" />
          </span>
          <div className="flex flex-col gap-2">
            ...
            <p className="text-lg leading-relaxed tracking-tight text-gray-600 max-w-xl">
              Join over 1000+ developers using our templates to design stunning
              emails for their applications. You can focus on core features of
              your applications and leave the designing to us. Pick from our
              collection of stunning email templates and get started.
            </p>
          </div>
          <div className="flex flex-row gap-4">
            <Link href={siteConfig.baseLinks.templates}>
              <Button className="gap-4">Explore Templates</Button>
            </Link>
