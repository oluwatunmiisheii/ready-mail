		...
		<footer className="bg-white py-12">
				...
				<nav className="grid grid-cols-1 md:grid-cols-2 text-gray-700 text-sm">
					<div className="col-span-1">
						...
						<p className="text-gray-500 mt-4">
							You need not worry about designing email templates
							anymore, you can focus on core fetures of your
							applications. Pick from our collection of stunning
			...
			<Section className="py-0">
				<div className="grid grid-cols-1 md:grid-cols-2 text-gray-700 text-sm">
					...
					<div className="flex items-center justify-end col-span-1 gap-8">
